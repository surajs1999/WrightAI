...
const TESTIMONIALS = [
  {
    quote: "Wright generated docs for our entire payments module in under 30 seconds. Our new engineers can actually understand the codebase now.",
    name: "Sarah Chen",
    handle: "@schen_dev",
  ...
  {
    quote: "The drift detection caught a breaking API change in CI before it hit production. Saved us a 2am incident.",
    name: "Marcus Webb",
    handle: "@mwebb",
    role: "Platform Lead",
    company: "Linear",
  ...
  {
    quote: "search_docs via MCP is magic. I asked Claude 'how does our auth work' and got back accurate, current answers straight from our own codebase.",
    name: "Priya Nair",
    handle: "@priyanair",
    role: "Staff Engineer",
    company: "Vercel",
  ...
  {
    quote: "We went from 12% to 74% documentation coverage in one afternoon. The coverage report in CI keeps it from ever slipping back.",
    name: "Tom Lindqvist",
    handle: "@tlindqvist",
    role: "CTO",
    company: "Brainly",
  ...
  {
    quote: "llms.txt auto-generation is a killer feature. Every AI tool that touches our repo now has full context. Completely zero config.",
    name: "Alex Rivera",
    handle: "@arivera_hq",
    role: "DevRel",
    company: "Anthropic",
  ...
  {
    quote: "Best VS Code extension I've installed this year. The Generate tab just works — click, review, commit. That's the whole flow.",
    name: "Jordan Park",
    handle: "@jordanpark",
    role: "IC5 Engineer",
    company: "Google",
